...
while True:
    ...
    for rundor_number in range(1, rundor + 1):
        ...
        # Spara spelarens poäng för denna runda
        spelare_poäng_per_runda.append(spelare_total)
    ...
    # Hitta spelarens bästa och sämsta runda
    bästa_poäng = max(spelare_poäng_per_runda)
    bästa_runda = spelare_poäng_per_runda.index(bästa_poäng) + 1  # Lägg till 1 för att få rätt runda

    sämsta_poäng = min(spelare_poäng_per_runda)
    sämsta_runda = spelare_poäng_per_runda.index(sämsta_poäng) + 1  # Lägg till 1 för att få rätt runda

    # Informera spelaren om den bästa och sämsta rundan
